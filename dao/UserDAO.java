...
public class UserDAO {
	...
	/**
	 * Thêm một User mới (dùng cho đăng ký). Trả về ID của User vừa được tạo (quan
	 * trọng để liên kết với Reader).
	 */
	...
	/**
	 * Cập nhật thông tin cơ bản của User (không bao gồm mật khẩu). Mật khẩu nên có
	 * hàm riêng (changePassword).
	 */
	...
	/**
	 * Xóa một User khỏi CSDL. LƯU Ý QUAN TRỌNG: Hàm này sẽ thất bại nếu userId này
	 * đang được liên kết trong bảng Readers (lỗi khóa ngoại). Bạn phải xóa Reader
	 * liên kết trước khi xóa User.
	 */
	...
	/**
	 * Hàm kiểm tra email và cập nhật mật khẩu
	 */
	// HÀM Kiểm tra xem Username và Email có khớp nhau không
    ...
    // HÀM Đổi mật khẩu dựa trên Username (cho chính xác hơn)
